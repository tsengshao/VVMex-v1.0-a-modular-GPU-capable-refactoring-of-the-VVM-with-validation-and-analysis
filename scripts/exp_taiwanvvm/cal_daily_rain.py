...
CASES = {
    "original": CaseConfig(
        ...
        vvm_case=ROOT_DIR / "VVM/case_taiwanvvm_f1_aaron",
        vvmex_case=ROOT_DIR / "VVMex/taiwanvvm_20120819_good_luck",
        nx=1024,
        ny=1024,
    ),
    "large": CaseConfig(
        ...
        vvm_case=ROOT_DIR / "VVM/case_taiwanvvm_f1_Large_aaron",
        vvmex_case=ROOT_DIR / "VVMex/taiwanvvm_20120819_2048_64gpus_newtopo_test",
        nx=2048,
        ny=2048,
